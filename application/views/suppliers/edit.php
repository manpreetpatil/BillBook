<div class="card">
    ...
    <form action="<?php echo site_url('suppliers/edit/' . $supplier->id); ?>" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" name="gstin" class="form-control" value="<?php echo $supplier->gstin; ?>">
        </div>
        ...
        <div style="display: flex; gap: 12px;">
            <button type="submit" class="btn btn-primary">
                <i class="fas fa-save" style="margin-right: 8px;"></i> Update Supplier
            </button>
